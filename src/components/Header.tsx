    ...
    <header className="text-center mb-16">
      ...
      >
        ...
        <motion.div 
          ...
          transition={{ type: "spring", stiffness: 300 }}
        >
          <div className="absolute inset-0 bg-gradient-to-br from-telkom-red to-telkom-brightRed rounded-3xl blur-lg opacity-75"></div>
          <div className="relative p-6 bg-gradient-to-br from-telkom-red to-telkom-brightRed rounded-3xl shadow-2xl">
      ...
      <motion.h1 
        className="text-6xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-telkom-red via-telkom-brightRed to-telkom-red bg-clip-text text-transparent leading-tight"
